...
async function updateJsonWithSpanishChars() {
  ...
  let currentData = await getFile('vaxi/samples.json');
  console.log('currentData',currentData.content);
  return;
  
  const FILE_PATH = 'vaxi/sample.json'; // e.g., 'data/spanish.json'
  const BRANCH = 'main';
  try {
...
*/
 ...
 async function saveJson() {
     const GITHUB_FILE_PATH = "vaxi/sample.json"; // Path inside the repo
