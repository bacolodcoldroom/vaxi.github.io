...
function show_sidenav(){
  ...
  let dtl=
  '<div id="div_left_box" style="width:100px;height:'+H_BODY+'px;margin-top:'+mtop+'px;font-size:9px;border:0px solid violet;background:darkslategray;">'+
    ...
    '<div class="dropdown">'+
      ...
      '</div>'+
      '<div class="dropdown-content">'+
        '<a href="javascript:fm_receive()">Receive</a>'+
        '<a href="javascript:fm_ret()">Returns</a>'+
        '<a href="javascript:fm_adjust()">Adjustments</a>'+
        '<a href="javascript:fm_transfer()">Location/Storage</a>'+
        '<a href="javascript:main_ptr(1)">RIS COVAC</a>'+
        '<a href="javascript:main_ptr(3)">RIS Regular</a>'+
      '</div>'+
    '</div>'+
